...
namespace System.Threading.Algorithms
{
    ...
    {
        /// <summary>Invokes the specified <paramref name="functions"/>, potentially in parallel, canceling outstanding invocations once one completes.</summary>
        ...
        /// <returns>A result from executing one of the <paramref name="functions"/>.</returns>
