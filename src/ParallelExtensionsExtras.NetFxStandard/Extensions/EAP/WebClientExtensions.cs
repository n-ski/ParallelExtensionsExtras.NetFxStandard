...
namespace System.Net
{
    ...
    {
        /// <summary>Downloads the resource with the specified URI as a <see cref="byte"/> array, asynchronously.</summary>
        /// <param name="webClient">The <see cref="WebClient"/>.</param>
        /// <param name="address">The URI from which to download data.</param>
        /// <returns>A <see cref="Task"/> that contains the downloaded data.</returns>
        ...
        /// <summary>Downloads the resource with the specified URI as a <see cref="string"/>, asynchronously.</summary>
        /// <param name="webClient">The <see cref="WebClient"/>.</param>
        /// <param name="address">The URI from which to download data.</param>
        /// <returns>A <see cref="Task"/> that contains the downloaded string.</returns>
        ...
        /// <summary>Opens a readable <see cref="Stream"/> for the data downloaded from a resource, asynchronously.</summary>
        /// <param name="webClient">The <see cref="WebClient"/>.</param>
        /// <param name="address">The URI for which the stream should be opened.</param>
        /// <returns>A <see cref="Task"/> that contains the opened stream.</returns>
        ...
        /// <summary>Opens a writeable <see cref="Stream"/> for uploading data to a resource, asynchronously.</summary>
        /// <param name="webClient">The <see cref="WebClient"/>.</param>
        /// <param name="address">The URI for which the stream should be opened.</param>
        ...
        /// <returns>A <see cref="Task"/> containing the data in the response from the upload.</returns>
        ...
        /// <summary>Uploads data in a <see cref="string"/> to the specified resource, asynchronously.</summary>
        /// <param name="webClient">The <see cref="WebClient"/>.</param>
        /// <param name="address">The URI to which the data should be uploaded.</param>
        /// <param name="method">The HTTP method that should be used to upload the data.</param>
        /// <param name="data">The data to upload.</param>
